...
<html lang="en">
  ...
  <body>
    <section id="main-card">
      ...
      <div class="forms">
        <form action="./Assets/PHP/Sign in.php" method="post">
          <div class="user-name">
            ...
            <input type="email" name="user-name" placeholder="User Name" />
          </div>
          <div class="password">
            <svg class="svg-icon" viewBox="0 0 20 20">
              <path
          ...
          <div class="recovery">
            <p><a href="#">Forgot password? </a> or <a href="./Sign up.html">Sign up</a></p>
          </div>
        </form>
      </div>
    </section>
