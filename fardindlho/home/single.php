...
<head>
    <!--
        create by fardin alizadeh
    -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Fardin Alizadeh</title>
...
<body data-spy="scroll" data-target="#navbar" class="static-layout">
	...
	<div class="sidenav-content">
		<p>
			Hi, i'm fardin Alizadeh.
		</p>
		<p>
			<span class="fs-16 primary-color">09019864514</span>
		</p>
		<p>FardinAlizadeh3007@protonmail.com</p>
	</div>
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center text-white" href="/">
            <h3 class="font-weight-bolder mb-0">Fardin Alizadeh</h3>
        </a>
...
<div id="side-nav" class="sidenav">
  ...
  <div class="container text-center">
      <h1>Welcom to the</h1>
    <h1 class="display-2 mb-4">Fardin Blog</h1>
  </div>
